...
from gymnasium.envs.toy_text.blackjack import BlackjackEnv, score, is_bust
import csv
import pandas as pd
...
def get_action(state, device):
	...
	masked_scores[mask == 0] = 1e-9  # large negative number to disable invalid moves
...
def test_dqn_agent(model, env, num_episodes, device="cpu"):
	...
	for _ in tqdm(range(num_episodes)):
        ...
        # After episode ends, compare final scores
...
def save_to_csv(model):
	...
	# --- Save to CSV ---
	df.to_csv("blackjack_DQN_800.csv", index=False)
	print("Saved to blackjack_DQN_800.csv")
...
#TODO talk about layers in the network
